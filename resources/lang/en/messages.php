...
Smartly or Earn. ',
  ...
  'picked up' => 'Picked up',
  'Paid bazar and cash' => 'Paid bazar and cash',
  'bKash Parsonal' => 'BKash Parsonal',
  ...
  'marchent_number' => 'Marchent number',
  ...
  'Invalid referer code' => 'Invalid referer code',
  'top' => 'Top',
  'bottom' => 'Bottom',
  'smart_banner_setup' => 'Smart banner setup',
  'add_smart_banner' => 'Add smart banner',
  'set_up_some_banners_to_showcase_modules_categories_and_vendors_right_from_the_home_page_of_the_customer_app.' => 'Set up some banners to showcase modules categories and vendors right from the home page of the customer app.',
  'Additional Delivery Charge Setup' => 'Additional Delivery Charge Setup',
  'If enable this feature customers will receive option to choose delivery type' => 'If enable this feature customers will receive option to choose delivery type',
  'Threshold Delivery Time' => 'Threshold Delivery Time',
  'Set a minimum delivery time. After reduction, the final delivery time cannot be lower than this limit.' => 'Set a minimum delivery time. After reduction, the final delivery time cannot be lower than this limit.',
  ...
  'Add extra charge to the delivery fee. This amount will be added to the total delivery charge.' => 'Add extra charge to the delivery fee. This amount will be added to the total delivery charge.',
  'Reduce Delivery Time' => 'Reduce Delivery Time',
  'Set a reduced delivery time, ensuring the final delivery time is not less than minimum delivery time limit after deduction.' => 'Set a reduced delivery time, ensuring the final delivery time is not less than minimum delivery time limit after deduction.',
  'Slightly Delay Delivery' => 'Slightly Delay Delivery',
  'order_can_not_cancle_after_confirm' => 'Order can not cancle after confirm',
  'boshundhara' => 'Boshundhara',
  'jamuna' => 'Jamuna',
  'you_can_not_cancel_after_confirm' => 'You can not cancel after confirm',
  134181 => '134181',
  'Omera Gas' => 'Omera Gas',
  'Grocery Unused' => 'Grocery Unused',
  'Not Select' => 'Not Select',
  'order_can_not_be_edited' => 'Order can not be edited',
  'At least one login method must remain active for the
                                    customer. Otherwise they will be unable to log in to the
                                    system' => 'At least one login method must remain active for the
                                    customer. Otherwise they will be unable to log in to the
                                    system',
  'By enabling manual login,
                                                            customers will get the option
                                                            to create account & login using necessary
                                                            credentials & password in the
                                                            app & website' => 'By enabling manual login,
                                                            customers will get the option
                                                            to create account & login using necessary
                                                            credentials & password in the
                                                            app & website',
  'With OTP Login, customers
                                                            can log in using their phone
                                                            number without password. To enable this feature' => 'With OTP Login, customers
                                                            can log in using their phone
                                                            number without password. To enable this feature',
  'Configure SMS Setup ' => 'Configure SMS Setup ',
  'Here.' => 'Here.',
  'With Social Login, customers
                                                            can log in using social media
                                                            accounts. To enable this feature' => 'With Social Login, customers
                                                            can log in using social media
                                                            accounts. To enable this feature',
  'Configure Social Media Setup' => 'Configure Social Media Setup',
  'Social Media Login Setup' => 'Social Media Login Setup',
  'Apple is currently disabled from configure 3rd party social login options.' => 'Apple is currently disabled from configure 3rd party social login options.',
  'Enabling Apple Login, customers can log in to the site using their existing Apple login credentials, Only for Apple devicesusing' => 'Enabling Apple Login, customers can log in to the site using their existing Apple login credentials, Only for Apple devicesusing',
  ...
  'If Email verification is on, Customers must verify their email with an OTP to complete the signup process.' => 'If Email verification is on, Customers must verify their email with an OTP to complete the signup process.',
  ...
  'Firebase OTP is currently disabled from OTP setup options.' => 'Firebase OTP is currently disabled from OTP setup options.',
  'Set Up Mail Configuration First' => 'Set Up Mail Configuration First',
  'It looks like your Mail configuration is not set up yet. To enable the email verification, please set up the Mail configuration first.' => 'It looks like your Mail configuration is not set up yet. To enable the email verification, please set up the Mail configuration first.',
  ...
  'No item could be added to cart' => 'No item could be added to cart',
  'gas' => 'Gas',
  'item_is_out_of_stock' => 'Item is out of stock',
  'Your_account_is_suspended' => 'Your account is suspended',
  'new delivery test perpose' => 'New delivery test perpose',
  'store_is_not_available' => 'Store is not available',
  '১৩৪৩৮৯' => '১৩৪৩৮৯',
  '১৩৪৩৯১' => '১৩৪৩৯১',
  ...
  '20/02/23' => '20/02/23',
  '16/02/23' => '16/02/23',
  'Collecat Cash' => 'Collecat Cash',
  '14/02/23' => '14/02/23',
  'wrong' => 'Wrong',
  '13/2/2023' => '13/2/2023',
  'Order #100511' => 'Order #100511',
  '9/2/2023' => '9/2/2023',
  '7/2/2023' => '7/2/2023',
  '02/02/23' => '02/02/23',
  'Take Away' => 'Take Away',
  '31/1/2023' => '31/1/2023',
  '30/1/2023' => '30/1/2023',
  'Please add more options or change the max value forChoose any Pizza Size' => 'Please add more options or change the max value forChoose any Pizza Size',
  ...
  'Minimum delivery time cannot be less than reduce delivery time for module:' => 'Minimum delivery time cannot be less than reduce delivery time for module:',
  'Slightly delay delivery requires reduce charge and add delivery time for module:' => 'Slightly delay delivery requires reduce charge and add delivery time for module:',
  'Free_delivery_on' => 'Free delivery on',
  'On_orders_above' => 'On orders above',
  'Up_to' => 'Up to',
  'off_delivery_on' => 'Off delivery on',
  ...
  'The name field must contain only valid alphabetic characters.' => 'The name field must contain only valid alphabetic characters.',
  ...
  'prescription_is_required_for_this_order' => 'Prescription is required for this order',
);